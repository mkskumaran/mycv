				...
				<div className="ui-bg-overlay bg-dark opacity-50"></div>
					<div className="container-fluid">					
						...
						<div className="text-center py-5 mt-3 banner" style={{backgroundColor:'rgb(61 92 130 / 90%)',color:'#fff'}}>
							{loading ? <Skeleton circle={true} height={150} width={150}/> : <img src={me} alt="" className="rounded-circle"/>}
					...
					{loading ? <Skeleton height={50} count={1}/> :<footer className="text-center mt-3" style={{backgroundColor:'rgb(61 92 130 / 90%)',color:'#fff',padding:'1em'}}><i><span>Made by <span style={{color:'rgb(236 56 56)',width:'50px'}} title="React JS"> <Icon/></span> &copy; All Rights Reserved {n}</span></i>
					</footer>}
					<div className="mt-3"></div>
				</div>
			</div>
